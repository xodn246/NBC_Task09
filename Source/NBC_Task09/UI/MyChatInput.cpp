...
void UMyChatInput::NativeConstruct()
{
...
void UMyChatInput::NativeDestruct()
{
...
void UMyChatInput::OnChatInputTextCommitted(const FText& Text, ETextCommit::Type CommitMethod)
{
